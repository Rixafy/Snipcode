...
class SnippetFacade
{
     ...
     * @return Snippet
     */
    public function createSnippet(string $payload, string $syntax, DateTime $expireAt): Snippet
    {
        $snippet = $this->snippetRepository->create($payload, $this->profileFacade->getCurrentSession(), $this->profileFacade->getCurrentIpAddress(), $this->syntaxRepository->getReference($syntax), $expireAt);
